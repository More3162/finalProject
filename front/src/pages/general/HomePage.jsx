  ...
  return (
    ...
    >
      ...
      <Typography variant="h5" sx={{ mb: 4 }}>
        Discover new restaurants, place orders effortlessly, or manage your
        business smarter.
      </Typography>
        ...
        <Grid item xs={12} sm={4}>
          <Card>
            <CardContent>
              ...
              <Typography>
                Find restaurants and place orders in seconds.
              </Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} sm={4}>
          <Card>
            <CardContent>
              ...
              <Typography>
                Are you a restaurant owner? Manage your business effortlessly.
              </Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} sm={4}>
          <Card>
            <CardContent>
              ...
              <Typography>
                Access hundreds of restaurants in your area.
              </Typography>
            </CardContent>
          </Card>
        </Grid>
          ...
          <Card>
            <CardContent>
              <Typography variant="body1">
                "This platform completely changed how I order food. Simply
                amazing!"
              </Typography>
